...
<div style="text-align:center;">
    <figure style="display:inline-block;">
        ...
        <figcaption style="font-size: 15px; max-width: 90%; text-align:justify; margin: 0 auto; margin-top: -15px;">Drone image (left), vegetation structure model (center), and terrain elevation model (right) at the NASA wetland calibration/validation site in the Peruvian Amazon. Our team has dedicated years to conducting fieldwork and remote sensing investigations in the Amazon, advancing NASA wetland science research.</figcaption>
    </figure>
</div>
